...
import { createRegistrosEspaña } from "../redux/actions";
import {UserContext} from "../StreamerContext"
import { RegistrosEspañaBorrar } from "./RegistrosEspañaBorrar";

export const CreateRegistrosEspaña = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await dispatch(createRegistrosEspaña(registroData, user.username, user.password)); // Pasando las credenciales
  ...
  return (
    <div className='flex flex-col'>
      ...
      <div className='w-full justify-center text-2xl pt-[1rem] text-white flex'>
        <h1>CREAR Y ELIMINAR REGISTROS </h1>
      </div>
