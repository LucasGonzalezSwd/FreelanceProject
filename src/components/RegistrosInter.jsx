...
export const RegistrosInter = () => {
  const dispatch = useDispatch();
  const cards = useSelector((state) => state.registrosInter);
    ...
    <div className='flex justify-center items-center w-screen h-full  text-white'>
      ...
      <div className='flex max-[1100px]:flex-col  max-[1100px]:gap-y-[13rem] gap-x-[2.5rem] gap-y-[1rem] max-[510px]:gap-y-[9rem] max-[470px]:gap-y-[14rem] max-[1034px]:gap-y-[8rem] justify-center w-full flex-wrap items-center'>
        ...
        {cards.map((card,index) => (
          <div className='w-[26rem] max-[470px]:-mt-[1.5rem] max-[510px]:mt-[4.5rem]  max-[1134px]:-mt-[5.5rem] max-[1294px]:-mt-[0rem] max-[1034px]:-mt-[5.5rem]  max-[994px]:-mt-[3.5rem] max-[540px]:w-11/12 max-[510px]:mr-[0.4rem] max-[510px]:ml-[0.4rem] max-[1450px]:mt-[0.5rem] -mt-[5.5rem] max-[2000px]:mt-[4.4rem] max-[2800px]:mt-[7.5rem] max-[1648px]:mt-[1rem] min-[1650px]:w-[32rem] p-[2rem] pb-[1rem] flex flex-col bg-[#00000089] border-white border-[0.005rem] max-[1300px]:-mt-[5.5rem] min-[1650px]:p-[2.5rem] h-[22rem] max-[540px]:h-full  rounded-xl flex-wrap shadow-[4px_5px_13px_5px_rgba(0,0,0,0.60)]  max-[1100px]:-mt-[8.8rem] mb-[6rem] max-[510px]:-mb-[3.5rem] max-[1034px]:mb-[0rem] max-[1094px]:mb-[0rem]  max-[1134px]:mb-[2rem] max-[2000px]:mb-[2rem] max-[1294px]:mb-[5rem] mb' key={index}>

          <div className='object-contain h-[10rem] -mt-[2rem] w-full min-[1650px]:-mt-[3rem] flex justify-center items-center '>
            <img src={card.imagen} className='max-h-[8rem] min-h-[8rem] max-[400px]:max-h-[8rem] max-[400px]:min-h-[8rem]  max-[510px]:max-h-[8rem]  mb-[1rem] max-w-[15rem] max-[510px]:max-w-[13rem]  max-[400px]:max-w-[12rem] flex object-contain'/>
          </div>
