...
export const PromosInter = () => {
  ...
  return (
    <div className='flex flex-col  z-30 justify-center items-center w-screen h-full mt-[6rem]  text-white'>
...
<hr  className="border-0 border-t-[0.005rem] w-6/12 max-[963px]:w-8/12  border-[#ff1f977f]"/>
    ...
    <div className='flex flex-col items-center gap-[3rem]  justify-center w-full  mt-[3rem] flex-wrap   z-40'>
    {selectedCard && (
      ...
      {promos.map((card) => (
        ...
        <div className='w-3/4 max-[510px]:w-10/12 flex max-[1000px]:flex-col text-sm shadow-[4px_5px_13px_5px_rgba(0,0,0,0.60)] bg-[#0000007b] border-white justify-center items-center border-[0.005rem] max-[1000px]:h-[15rem] max-[360px]:h-[15rem] h-[7rem] rounded-xl mb-[1.5rem]' key={card.id}>
